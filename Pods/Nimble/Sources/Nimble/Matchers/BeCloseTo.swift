...
public extension Expectation where T == [Double] {
    // swiftlint:disable:next identifier_name
    static func ≈ (lhs: Expectation, rhs: [Double]) {
...
public extension Expectation where T == NMBDoubleConvertible {
    // swiftlint:disable:next identifier_name
    static func ≈ (lhs: Expectation, rhs: NMBDoubleConvertible) {
        lhs.to(beCloseTo(rhs))
    }

    // swiftlint:disable:next identifier_name
    static func ≈ (lhs: Expectation, rhs: (expected: NMBDoubleConvertible, delta: Double)) {
